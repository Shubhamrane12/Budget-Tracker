...
public class BudgetActivity extends AppCompatActivity {
    ...
    private DatabaseReference budgetRe, personalRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        budgetRe = FirebaseDatabase.getInstance().getReference().child("budget").child(mAuth.getCurrentUser().getUid());
        ...
        budgetRe.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (budgtItem.equals("Select item")){
                    ...
                    String id  = budgetRe.push().getKey();
                    ...
                    budgetRe.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
    ...
    private void updateData(){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                budgetRe.child(post_key).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
        ...
        delBut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                budgetRe.child(post_key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
    ...
    private void getMonthTransportBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Transport");
    ...
    private void getMonthFoodBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Food");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthHouseBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("House Expenses");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthEntBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Entertainment");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthEduBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Education");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthCharityBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Charity");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthAppBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Apparel and Services");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthHealthBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Health");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthPerBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Personal Expenses");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void getMonthOtherBudgetRatios(){
        Query query = budgetRe.orderByChild("item").equalTo("Other");
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
