...
//imageviews
    ...
    private void newDay(String date) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    Log.i("Date", "It's Same");
                    Set<String> hash_Set = new HashSet<String>();
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        Map<String, Object> map = (Map<String, Object>) ds.getValue();
                        Object item = map.get("item");
                        Object notes = map.get("notes");
                        Log.i("Date", "Item: "+item+"| notes: "+notes);

                        hash_Set.add((String) item);
                    }
                    Log.i("Date", "Set: "+hash_Set);
                    ...
                    for ( String setItem : hash_Set){
                        Log.i("Date", "item from for loop: "+setItem);
                        items.remove(setItem);
                    }

                    Log.i("Date", "New and improved List: "+items);
